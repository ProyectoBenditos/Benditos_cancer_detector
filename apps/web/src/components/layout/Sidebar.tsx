    ...
    <aside className="w-64 bg-brand-sidebar text-slate-400 flex flex-col h-screen fixed left-0 top-0 border-r border-slate-900">
      ...
      <nav className="flex-1 py-6 px-3 space-y-1 overflow-y-auto">
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all font-medium ${isActive('/platform/analyze') ? 'bg-slate-800 text-white shadow-sm' : 'hover:bg-slate-800 hover:text-slate-200'}`}
        >
